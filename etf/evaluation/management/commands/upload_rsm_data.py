...
AlternateChoice(label="Social Mobility & Child Poverty Commission", name="social-mobility-and-child-poverty-commission"),
# AlternateChoice(label="Other (Department of Health)", name=enums.Organisation..name),
# AlternateChoice(label="Department for Science, Innovation & Technology", name=enums.Organisation..name),
# AlternateChoice(label="Department of Health and Social Care", name=enums.Organisation..name),
# AlternateChoice(label="HM Treasury (HMT)", name=enums.Organisation..name),
# AlternateChoice(label="Department for Digital, Culture, Media & Sport; Office for Artificial Intelligence", name=enums.Organisation..name),
# AlternateChoice(label="European Parliament´s Directorate for Budgetary Affairs", name=enums.Organisation..name),
# AlternateChoice(label="Department for Science, Innovation and Technology", name=enums.Organisation..name),
# AlternateChoice(label="Innovate UK", name=enums.Organisation..name),
# AlternateChoice(label="Department of Agriculture, Environment and Rural Affairs", name=enums.Organisation..name),
# AlternateChoice(label="AQA", name=enums.Organisation..name),
# AlternateChoice(label="Environment Agency", name=enums.Organisation..name),
# AlternateChoice(label="Ofqual", name=enums.Organisation..name),
# AlternateChoice(label="Department of Energy and Climate Change (DECC) and BIS", name=enums.Organisation..name),
# AlternateChoice(label="Youth Justice Board for England and Wales", name=enums.Organisation..name),
# AlternateChoice(label="Department of Health and Social Care, Department for Education and NHS England and Improvement", name=enums.Organisation..name),
# AlternateChoice(label="Ministry for Housing, Communities and Local Government (MHCLG)", name=enums.Organisation..name),
# AlternateChoice(label="The British Business Bank", name=enums.Organisation..name),
# AlternateChoice(label="Nuclear Waste Services", name=enums.Organisation..name),
# AlternateChoice(label="Department for Energy Security & Net Zero", name=enums.Organisation..name),
# AlternateChoice(label="Highways England", name=enums.Organisation..name),
# AlternateChoice(label="HM Prison and Probation Service", name=enums.Organisation..name),
# AlternateChoice(label="Department for Energy Security and Net Zero", name=enums.Organisation..name),
# AlternateChoice(label="Office for Health Improvement and Disparities", name=enums.Organisation..name),
# AlternateChoice(label="Department of Health Policy Research Programme", name=enums.Organisation..name),
# AlternateChoice(label="Department of Health", name=enums.Organisation..name),
# AlternateChoice(label="Department for Education", name=enums.Organisation..name),
# AlternateChoice(label="NIHR", name=enums.Organisation..name),
# AlternateChoice(label="Department for Digital, Culture, Media & Sport", name=enums.Organisation..name),
# AlternateChoice(label="Obesity Policy Research Unit", name=enums.Organisation..name),
# AlternateChoice(label="Department for Environment, Food & Rural Affairs", name=enums.Organisation..name),
# AlternateChoice(label="Department for Transport", name=enums.Organisation..name),
# AlternateChoice(label="Other (please state) Parliament", name=enums.Organisation..name),
# AlternateChoice(label="Government Social Research", name=enums.Organisation..name),
# AlternateChoice(label="UK government", name=enums.Organisation..name),
# AlternateChoice(label="Oxfordshire Safeguarding Children Board (OSCB)", name=enums.Organisation..name),
# AlternateChoice(label="Land Use Policy Group", name=enums.Organisation..name),
# AlternateChoice(label="Uk Trade & Investment", name=enums.Organisation..name),
# AlternateChoice(label="Department for Levelling Up, Housing and Communities", name=enums.Organisation..name),
# AlternateChoice(label="Public Health England", name=enums.Organisation..name),
# AlternateChoice(label="Department for Science, Innovation and Technology; Office for Artificial Intelligence; Department for Digital, Culture, Media & Sport; Department for Business, Energy & Industrial Strategy", name=enums.Organisation..name),
# AlternateChoice(label="King's College London", name=enums.Organisation..name),
# AlternateChoice(label="Department for Work and Pensions | Government Social Research Profession", name=enums.Organisation..name),
# AlternateChoice(label="British Business Bank", name=enums.Organisation..name),
# AlternateChoice(label="Home Office", name=enums.Organisation..name),
# AlternateChoice(label="UK Space Agency", name=enums.Organisation..name),
# AlternateChoice(label="Other (UK Health Security Agency)", name=enums.Organisation..name),
# AlternateChoice(label="Closed organisation: Ministry of Housing, Communities & Local Government", name=enums.Organisation..name),
# AlternateChoice(label="HM Government", name=enums.Organisation..name),
# AlternateChoice(label="Building Digital UK", name=enums.Organisation..name),
# AlternateChoice(label="UK Trade & Investment", name=enums.Organisation..name),
# AlternateChoice(label="Other (please state) Department for Communities and Local Government", name=enums.Organisation..name),
# AlternateChoice(label="Department for Digital, Culture, Media and Sport", name=enums.Organisation..name),
# AlternateChoice(label="Office of Manpower Economics | Home Office", name=enums.Organisation..name),
# AlternateChoice(label="Ministry of Justice | HM Prison and Probation Service", name=enums.Organisation..name),
# AlternateChoice(label="Closed organisation: Highways England", name=enums.Organisation..name),
# AlternateChoice(label="UK Research and Innovation", name=enums.Organisation..name),
# AlternateChoice(label="Department for Work and Pensions | Department of Health and Social Care", name=enums.Organisation..name),
# AlternateChoice(label="Animal and Plant Health Agency", name=enums.Organisation..name),
# AlternateChoice(label="Department of work and pensions", name=enums.Organisation..name),
# AlternateChoice(label="Department for Business & Trade", name=enums.Organisation..name),
# AlternateChoice(label="Department for Culture, Media & Sport", name=enums.Organisation..name),
# AlternateChoice(label="HM Revenue & Customs | HM Treasury", name=enums.Organisation..name),
# AlternateChoice(label="Building Digital UK | Department for Digital, Culture, Media & Sport", name=enums.Organisation..name),
# AlternateChoice(label="Closed organisation: Department for Business, Innovation & Skills", name=enums.Organisation..name),
# AlternateChoice(label="Closed organisation: Department of Energy & Climate Change", name=enums.Organisation..name),
# AlternateChoice(label="Department for Business, Energy & Industrial Strategy", name=enums.Organisation..name),
# AlternateChoice(label="Office for Zero Emission Vehicles", name=enums.Organisation..name),
# AlternateChoice(label="HM Prison & Probation Service", name=enums.Organisation..name),
# AlternateChoice(label="Government Equalities Office", name=enums.Organisation..name),
# AlternateChoice(label="Foreign, Commonwealth & Development Office", name=enums.Organisation..name),
# AlternateChoice(label="DCMS", name=enums.Organisation..name),
# AlternateChoice(label="Department for Levelling Up, Housing & Communities", name=enums.Organisation..name),
# AlternateChoice(label="UK Commission for Employment and Skills (UKCES)", name=enums.Organisation..name),
# AlternateChoice(label="Department for Transport (DfT)", name=enums.Organisation..name),
# AlternateChoice(label="Driving Standards Agency (DSA)", name=enums.Organisation..name),
# AlternateChoice(label="Competition and Markets Authority", name=enums.Organisation..name),
# AlternateChoice(label="culture, media, and sport", name=enums.Organisation..name),
# AlternateChoice(label="Senior Salaries Review Body", name=enums.Organisation..name),
# AlternateChoice(label="Other (Public Health England)", name=enums.Organisation..name),
# AlternateChoice(label="Department of Energy and Climate Change", name=enums.Organisation..name),
# AlternateChoice(label="Regulator of Social Housing", name=enums.Organisation..name),
# AlternateChoice(label="Closed organisation: Highways Agency", name=enums.Organisation..name),
# AlternateChoice(label="Ofsted", name=enums.Organisation..name),
# AlternateChoice(label="The Institute for Fiscal Studies", name=enums.Organisation..name),
# AlternateChoice(label="Highways Agency", name=enums.Organisation..name),
# AlternateChoice(label="Driver & Vehicle Standards Agency", name=enums.Organisation..name),
# AlternateChoice(label="Closed organisation: Public Health England", name=enums.Organisation..name),
# AlternateChoice(label="Department for Work and Pensions", name=enums.Organisation..name),
# AlternateChoice(label="UK Health Security Agency", name=enums.Organisation..name),
# AlternateChoice(label="Department for Levelling Up, Housing and Communities | Cabinet Office", name=enums.Organisation..name),
# AlternateChoice(label="Cabinet Office", name=enums.Organisation..name),
# AlternateChoice(label="Standards and Testing Agency", name=enums.Organisation..name),
# AlternateChoice(label="HM Revenue & Customs", name=enums.Organisation..name),
# AlternateChoice(label="Department for Science, Innovation and Technology; Department for Digital, Culture, Media & Sport", name=enums.Organisation..name),
# AlternateChoice(label="Office for Budget Responsibility", name=enums.Organisation..name),
# AlternateChoice(label="UK Commission for Employment and Skills", name=enums.Organisation..name),
# AlternateChoice(label="The Charity Commission", name=enums.Organisation..name),
# AlternateChoice(label="Public Health Agency, Northern Ireland", name=enums.Organisation..name),
# AlternateChoice(label="Department for Work and Pensions.", name=enums.Organisation..name),
# AlternateChoice(label="Department for Business Innovation & Skills", name=enums.Organisation..name),
# AlternateChoice(label="Scientific Advisory Group for Emergencies", name=enums.Organisation..name),
# AlternateChoice(label="Evaluation Task Force", name=enums.Organisation..name),
# AlternateChoice(label="Government Social Research Profession", name=enums.Organisation..name),
# AlternateChoice(label="Ministry of Justice", name=enums.Organisation..name),
# AlternateChoice(label="Department for Digital, Culture, Media & Sport (DCMS); and the Ministry of Housing, Communities and Local Government (MCHLG).", name=enums.Organisation..name),
# AlternateChoice(label="Ministry of Housing, Communities and Local Government", name=enums.Organisation..name),
# AlternateChoice(label="Qualifications and Curriculum Authority", name=enums.Organisation..name),
# AlternateChoice(label="NIHR Policy Research Unit in Health and Social Care Systems and Commissioning", name=enums.Organisation..name),
# AlternateChoice(label="Department for Communities and Local Government", name=enums.Organisation..name),
# AlternateChoice(label="Department of Health Policy Research", name=enums.Organisation..name),
# AlternateChoice(label="Department for Environment, Food & Rural Affairs | Home Office", name=enums.Organisation..name),
# AlternateChoice(label="Ministry for Housing, Communities and Local Government", name=enums.Organisation..name),
# AlternateChoice(label="Ministry of Justice and HM Prison and Probation Service", name=enums.Organisation..name),
# AlternateChoice(label="Department for Digital, Culture Media & Sport; Arts Council England", name=enums.Organisation..name),
)
